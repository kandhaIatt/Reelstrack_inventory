...
public class Mill {
    ...
    public Mill(String id, String name, String place, String grades) {
        this(id, name, place, grades, true);
    }
    ...
    public static class MillBuilder {
        ...
        public MillBuilder id(String id) {
            this.id = id;
            return this;
        }

        public MillBuilder name(String name) {
            this.name = name;
            return this;
        }

        public MillBuilder place(String place) {
            this.place = place;
            return this;
        }

        public MillBuilder grades(String grades) {
            this.grades = grades;
            return this;
        }

        public MillBuilder active(Boolean active) {
            this.active = active;
            return this;
        }
